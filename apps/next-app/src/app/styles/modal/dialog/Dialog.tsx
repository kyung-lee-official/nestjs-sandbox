...
const DialogContent = forwardRef(function DialogContent(
  ...
  return (
    ...
    >
      ...
      <p>
        In this example, we hope that states should be reset when dialog is
        closed, if we simply use `showDialog && &lt;Dialog /&gt;`, it works fine
        on Windows Chrome and Android Chrome, but the dialog will disappear on
        iOS.
      </p>
      <p>
        To avoid this, we use `dialogRef.current` to close and open the dialog,
        but never unmout it. Instead, we unmout the dialog&apos;s child, which
        is DialogContent. This way, the states will be reset when the dialog is
        closed while the dialog shows correctly on iOS.
      </p>
