  ...
  return (
    <div className="flex gap-4 bg-slate-400">
      ...
      <div>
        ...
        placeat, voluptates consectetur non numquam quasi corporis temporibus
        aperiam quo quam iste amet provident, consequatur veniam optio,
        veritatis earum perferendis officiis!
      </div>
    </div>
  );
};
  ...
  return (
    <div className="flex flex-col w-full min-h-screen p-10 gap-20">
      ...
      <div className="flex flex-col gap-10">
        ...
        <FixedAspectRatioCard src={"/images/styles/image/horizontal.jpg"} />
        <FixedAspectRatioCard src={"/images/styles/image/vertical.jpg"} />
        <FixedAspectRatioCard src={"/images/styles/image/400x400.jpg"} />
      </div>
      <div className="flex flex-col gap-10">
        <h1 className="text-4xl">Ant Image in Fixed Aspect Ratio Div</h1>
        <AntFixedAspectRatioCard src={"/images/styles/image/horizontal.jpg"} />
        <AntFixedAspectRatioCard
          src={"/images/styles/image/vertical.jpg"}
          error={true}
        />
        <AntFixedAspectRatioCard src={"/images/styles/image/400x400.jpg"} />
      </div>
    </div>
  );
};
