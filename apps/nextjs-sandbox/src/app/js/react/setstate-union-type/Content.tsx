...
const Child = ({
  ...
  return (
    <div className="p-2">
      ...
      <p>
        If you hope the Child component to accept a union type for number or
        undefined, don&apos;t do this:
      </p>
      <p>
        <del>
          <code>{"Dispatch<SetStateAction<number | undefined>>;"}</code>
        </del>
      </p>
...
export const Content = () => {
  ...
  return (
    <div>
      <Child n1={n} setN1={setN} n2={n} setN2={setN} n3={n} setN3={setN3} />
    </div>
  );
};
