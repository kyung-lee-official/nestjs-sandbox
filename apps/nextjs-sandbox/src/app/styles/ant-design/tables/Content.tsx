  ...
  const data = [
    {
      ...
      col4: 18889898989,
      col5: <div className="whitespace-nowrap">New York No. 1 Lake Park</div>,
      col6: "male",
    },
    {
      key: "2",
      ...
      col4: 18889898888,
      col2: 42,
      col5: <div className="whitespace-nowrap">London No. 1 Lake Park</div>,
      col6: "male",
    },
    {
      key: "3",
      ...
      col4: 18900010002,
      col5: <div className="whitespace-nowrap">Sydney No. 1 Lake Park</div>,
      col6: "male",
    },
    {
      key: "4",
      ...
      col3: <div className="whitespace-nowrap">0575-22098909</div>,
      col4: 18900010002,
      col5: <div className="whitespace-nowrap">London No. 2 Lake Park</div>,
      col6: "male",
    },
    {
      key: "5",
      ...
      col3: <div className="whitespace-nowrap">0575-22098909</div>,
      col4: 18900010002,
      col5: <div className="whitespace-nowrap">Dublin No. 2 Lake Park</div>,
      col6: "male",
    },
  ];
    ...
    <div className="flex flex-col w-full mx-auto p-10 gap-10">
      <div className="flex flex-col w-full gap-6">
        ...
        <h6 className="text-sm text-gray-400">
          Note: Ant Design cannot work with vanilla CSS, for example, it&apos;s
          not possible to change header style without using JS
        </h6>
        <ColSpanRowSpan />
      </div>
      <div className="flex flex-col w-full gap-6">
        ...
        >
          <div>
            Should avoid adding &quot;100vw&quot; to the `body` tag, it will
            cause the right edge of the `body` tag to be hidden by the vertical
            scrollbar:
          </div>
          <img src="/images/antd/tables/001.png" alt="overflow-x" />
          <div>
            If flexbox is used as the container, the flex item should be set to
            `min-width: 0` to allow the content to overflow the container. See{" "}
