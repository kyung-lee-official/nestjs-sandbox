...
export const Content = () => {
  ...
  return (
    <div className="m-8">
      ...
      <p className="mb-4">
        This is a simple integer input component that allows users to enter only
        decimal values. It also validates the input against minimum and maximum
        values.
      </p>
      <p className="mb-4">
      ...
      <div>
        <DecimalInput
          ...
          min={0}
        />
        <p className="mt-2 text-gray-500">Current value: {positiveOnly}</p>
      </div>
      <div>
